          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="space-y-2">
              ...
              <Select value={formData.level} onValueChange={(value) => onFormDataChange('level', value)}>
                ...
                <SelectContent>
                  <SelectItem value="100">Level 1 (100)</SelectItem>
                  <SelectItem value="200">Level 2 (200)</SelectItem>
                  <SelectItem value="300">Level 3 (300)</SelectItem>
                  <SelectItem value="400">Level 4 (400)</SelectItem>
                  <SelectItem value="500">Level 5 (500)</SelectItem>
                </SelectContent>
              </Select>
            </div>
            <div className="space-y-2">
